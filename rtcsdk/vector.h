...
template<typename Dest, typename T>
using push_back_t = push_back<Dest, T>::type;
...
template<typename Dest, typename T>
using push_front_t = push_front<Dest, T>::type;
...
template<typename A, typename B>
using append_t = append<A, B>::type;
...
template<typename First, typename... Rest>
struct back<vector<First, Rest...>> : back<vector<Rest...>> {};

template<typename Last>
struct back<vector<Last>> {
    using type = Last;
};

template<typename T>
using back_t = back<T>::type;
...
template<typename T>
using remove_front_t = remove_front<T>::type;

template<typename T>
struct remove_back;

template<typename First>
struct remove_back<vector<First>> {
    using type = vector<>;
};

template<typename First, typename... Rest>
struct remove_back<vector<First, Rest...>> {
    using type = push_front_t<typename remove_back<vector<Rest...>>::type, First>;
};

template<typename T>
using remove_back_t = remove_back<T>::type;
...
template<typename T>
using as_tuple_t = as_tuple<T>::type;
